...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-md shadow-md dark:shadow-lg dark:shadow-gray-800/50 py-3 md:py-4 px-4 md:px-6 flex justify-between items-center border-b border-border h-[70px]">
      {/* Logo */}
      <Logo />
